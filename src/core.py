...
class Error:
    ...
    def as_string(self):
        ...
        result += '\n\n' + str.string_with_arrows(self.pos_start.ftext, self.pos_start, self.pos_end)
        return result
...
class Lexer:
    ...
    def make_tokens(self):
        ...
        while self.current_char != None:
            if self.current_char in ' \t':
                ...
                self.advance()
                return [], IllegalCharacterError(pos_start, self.pos.idx, f"'{char}'")          
    ...
    def make_number(self):
        ...
        if dot_count == 0:
            return Token(TT_INT, int(num_as_string), pos_start, self.pos)
        else:
            return Token(TT_FLOAT, float(num_as_string), pos_start, self.pos)
